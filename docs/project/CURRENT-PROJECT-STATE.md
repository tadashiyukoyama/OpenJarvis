...
| pullRequest | OJ3-B draft PR — Codex app-server client core; CI pending at commit |
| lifecycleAutomation | DISABLED |
| ci | OJ3-B checks pending; compileall and manual fake app-server PASS; local pytest unavailable |
...
and has its own CI/review gate.
